...
RUN mamba install -c bioconda -y fastqc=0.12.1 fastp=1.0.1 bioconductor-deepsnv=1.48.0 r-vcfr=1.15.0 r-seqinr=4.2_36 snakemake=9.1.1 snakemake-executor-plugin-slurm bwa=0.7.19 biobambam=2.0.185 verifybamid2=2.0.1 gatk=3.8
